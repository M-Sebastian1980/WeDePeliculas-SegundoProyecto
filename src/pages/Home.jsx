...
const cienciaFiccion = [
  { id: 101, titulo: 'SIN PIEDAD', imagen: '' },
  { id: 102, titulo: 'JURASSIC WORLD: Renace', imagen: '' },
  { id: 103, titulo: 'MICKEY 17', imagen: '' },
  { id: 104, titulo: 'CONTROL ROOM', imagen: '' },
  { id: 105, titulo: 'LOS 4 FANTASTICOS', imagen: '' },
  { id: 106, titulo: 'CAZADORES DEL FIN DEL MUNDO', imagen: '' },
  { id: 107, titulo: 'COMPAÑERA PERFECTA', imagen: '' },
  { id: 108, titulo: 'ASH', imagen: '' },
  { id: 109, titulo: 'TRON ARES', imagen: '' },
  { id: 110, titulo: 'AVATAR: Fuego y Cenizas', imagen: '' },
  { id: 211, titulo: 'SUPERMAN', imagen: '' },
  { id: 122, titulo: 'DEPREDADOR: Tierras Salvajes', imagen: '' },
  { id: 123, titulo: 'LAZARUS', imagen: '' },
  { id: 124, titulo: 'HENRY DANGER: La Pelicula', imagen: '' },
  { id: 125, titulo: 'SPLIT FICTION', imagen: '' },
  { id: 126, titulo: 'LOS PROTEGIDOS', imagen: '' },
  { id: 127, titulo: 'UN FUTURO BRILLANTE', imagen: '' },
  { id: 128, titulo: 'EL DESCENDIENTE', imagen: '' },
  { id: 129, titulo: 'RUR', imagen: '' },
  { id: 200, titulo: 'PRIMAL GAMES', imagen: '' },
]

const animacion = [
  { id: 201, titulo: 'ZOOTOPIA 2', imagen: '' },
  { id: 202, titulo: 'PITUFOS', imagen: '' },
  { id: 203, titulo: 'EL REY DE REYES', imagen: '' },
  { id: 204, titulo: 'JUNK WORLD', imagen: '' },
  { id: 205, titulo: 'ELIO', imagen: '' },
  { id: 206, titulo: 'EFECTOS COLATERALES', imagen: '' },
  { id: 207, titulo: 'LA FAMILIA MAS FELIZ DE LA NACION', imagen: '' },
  { id: 208, titulo: 'TU AMIGHO Y VECINO SPIDERMAN', imagen: '' },
  { id: 209, titulo: 'HEIDI, EL RESCATE DE LINCE', imagen: '' },
  { id: 210, titulo: 'GANES O PIERDAS', imagen: '' },
  { id: 211, titulo: 'JESUS, LUZ DEL MUNDO', imagen: '' },
  { id: 212, titulo: 'EL TESORI DE BARRACUDA', imagen: '' },
  { id: 213, titulo: 'LAS HERMANAS GRIMM', imagen: '' },
  { id: 214, titulo: 'HANNA Y LAS NAVIDADES OLVIDADAS', imagen: '' },
  { id: 215, titulo: 'TOM Y JERRY', imagen: '' },
  { id: 216, titulo: 'DORA', imagen: '' },
  { id: 217, titulo: 'EL GRAN PREMIO A TODA VELOCIDAD', imagen: '' },
  { id: 218, titulo: 'FARMAGA', imagen: '' },
  { id: 219, titulo: 'LOS TIPOS MALOS', imagen: '' },
  { id: 300, titulo: 'HIDDEN DRAGON', imagen: '' },
]

const western = [
  { id: 301, titulo: 'PISTOLEROS', imagen: '' },
  { id: 302, titulo: 'A PRAYER FOR THE DYING', imagen: '' },
  { id: 303, titulo: 'EMPEZAR DE NUEVO', imagen: '' },
  { id: 304, titulo: 'AJUSTE DE CUENTAS', imagen: '' },
  { id: 305, titulo: 'RUST: LA LEY DEL OESTE', imagen: '' },
  { id: 306, titulo: 'HIGH HORSE', imagen: '' },
  { id: 307, titulo: 'DJANGO IMBATIBLE', imagen: '' },
  { id: 308, titulo: 'BROKEN TRAIL', imagen: '' },
  { id: 309, titulo: 'FRONTIER CRUCIBLE', imagen: '' },
  { id: 310, titulo: 'GUNS OF REDEMPTION', imagen: '' },
  { id: 311, titulo: 'SOD AND STUBBLE', imagen: '' },
  { id: 312, titulo: 'AL NOROESTE DEL OESTE', imagen: '' },
  { id: 313, titulo: 'POR UN PUÑADO DE FRASES', imagen: '' },
  { id: 314, titulo: 'ROSEWATER', imagen: '' },
  { id: 315, titulo: 'LOS ABANDONADOS', imagen: '' },
  { id: 316, titulo: 'LUCKY LUKE', imagen: '' },
  { id: 317, titulo: 'TORNADO', imagen: '' },
  { id: 318, titulo: 'EL ULTIMO RODEO', imagen: '' },
  { id: 319, titulo: 'CINCO FORAJIDOS', imagen: '' },
  { id: 320, titulo: 'LALEYENDA DEL ESCANYAPOBRES', imagen: '' },
]
